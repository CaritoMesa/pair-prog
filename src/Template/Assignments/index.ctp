...
<div class="assignments index large-9 medium-8 columns content">
    <h3>
        <?= __('Assignments') ?>
        <?= $this->Html->link(__('<span class="glyphicon glyphicon-plus"></span> New'), ['controller' => 'Assignments', 'action' => 'add'], ['class' => 'btn btn-primary pull-right', 'escape' => false]) ?>
    </h3>
    <table cellpadding="0" cellspacing="0">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?= $assignment->has('user') ? $this->Html->link($assignment->user->first_name, ['controller' => 'Users', 'action' => 'view', $assignment->user->id]) : '' ?></td>
                <td><?= $assignment->has('group') ? $this->Html->link($assignment->group->name, ['controller' => 'Groups', 'action' => 'view', $assignment->group->id]) : '' ?></td>
                <td class="actions">
