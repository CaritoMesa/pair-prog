			...
			<fieldset>
				...
				<div class="row">
					<div class="col-xs-6 col-sm-6 col-md-6">
                        <?= $this->Form->button(__('Sign In'), ['class' => 'btn btn-lg btn-success btn-block']); ?>
					</div>
					<div class="col-xs-6 col-sm-6 col-md-6">
						<?= $this->Html->link(__('Register'), ['controller' => 'Users', 'action' => 'add'], ['class' => 'btn btn-lg btn-primary btn-block']); ?>
					</div>
				</div>
			</fieldset>
		<?= $this->Form->end() ?>
