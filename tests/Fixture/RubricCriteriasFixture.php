...
/**
 * RubricCriteriasFixture
 *
 */
class RubricCriteriasFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'CriteriosParaRubrica' => ['type' => 'foreign', 'columns' => ['rubric_id'], 'references' => ['rubrics', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
