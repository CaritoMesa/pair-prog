...
class SubmissionsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'submission' => ['type' => 'text', 'length' => null, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null],
        ...
        '_constraints' => [
            ...
            'activitiy_submission' => ['type' => 'foreign', 'columns' => ['id'], 'references' => ['activities', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
